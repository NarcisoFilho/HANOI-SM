...
#define EDITOR_QTD_LINES ( EDITOR_REC.height / EDITOR_TEXT_LINE_HEIGHT )
...
#define BUTTON_PLAY_RADIUS 30
#define BUTTON_PLAY (Rectangle){ WINDOW_WIDTH - 130 , EDITOR_REC_Y / 2.0  , BUTTON_PLAY_RADIUS , 4 }
#define BUTTON_PLAY_COLOR DARKGREEN

#define BUTTON_STEP_RADIUS 20
#define BUTTON_STEP (Rectangle){ BUTTON_PLAY.x + BUTTON_PLAY_RADIUS + 7 + BUTTON_STEP_RADIUS , EDITOR_REC_Y / 2.0  , BUTTON_STEP_RADIUS , 2.5 }
#define BUTTON_STEP_COLOR ORANGE

#define BUTTON_RESTART_RADIUS 20
#define BUTTON_RESTART (Rectangle){ BUTTON_STEP.x + BUTTON_RESTART_RADIUS + 7 + BUTTON_RESTART_RADIUS , EDITOR_REC_Y / 2.0  , BUTTON_RESTART_RADIUS , 2.5 }
#define BUTTON_RESTART_COLOR MAROON

// SCROLL BAR
#define SCROLL_BAR_WIDTH 15
#define SCROLL_BAR_X (EDITOR_REC.x + EDITOR_REC.width - SCROLL_BAR_WIDTH)
#define SCROLL_BAR_REC_BG (Rectangle){ SCROLL_BAR_X , EDITOR_REC_Y , SCROLL_BAR_WIDTH , EDITOR_REC.height }
#define SCROLL_BAR_COLOR_BG CLITERAL(Color){ 200, 200, 200, 105 }

#define SCROLL_BAR_ARROW_UP (Rectangle){ SCROLL_BAR_X , EDITOR_REC_Y , SCROLL_BAR_WIDTH , SCROLL_BAR_WIDTH }
#define SCROLL_BAR_ARROW_DOWN (Rectangle){ SCROLL_BAR_X , EDITOR_REC_Y + ( EDITOR_QTD_LINES - 1 ) * EDITOR_TEXT_LINE_HEIGHT , SCROLL_BAR_WIDTH , SCROLL_BAR_WIDTH }
